# Spring [![Build Status](https://travis-ci.org/emAmazed/redlamp.png?branch=master)](https://travis-ci.org/emAmazed/redlamp) [![devDependency Status](https://david-dm.org/zhaoda/spring/dev-status.png)](https://david-dm.org/zhaoda/spring#info=devDependencies) [![Total views](https://sourcegraph.com/api/repos/github.com/emAmazed/redlamp/counters/views.png)](https://sourcegraph.com/github.com/emAmazed/redlamp)
